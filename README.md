...
- 数据更新时间：**2026-09-15**
- 收录总数：**285** 个仓库（⭐ 已 star 142 个、🔥 热点推荐 143 个）
...
| 分类 | 数量 | 说明 |
| --- | ---: | --- |
| [飞控与无人机](categories/01-飞控与无人机.md) | 30 | PX4 / ArduPilot / 飞控板卡 / 无人机导航与仿真 |
| [电磁仿真与超表面](categories/02-电磁仿真与超表面.md) | 30 | FDTD / CST / 超表面与电磁材料设计 |
| [嵌入式与单片机](categories/03-嵌入式与单片机.md) | 68 | RTOS、MCU 生态、LVGL、MicroPython、调试与仿真工具 |
