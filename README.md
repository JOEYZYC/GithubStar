...
- 数据更新时间：**2026-09-14**
- 收录总数：**224** 个仓库（⭐ 已 star 141 个、🔥 热点推荐 83 个）
...
| 分类 | 数量 | 说明 |
| --- | ---: | --- |
| [飞控与无人机](categories/01-飞控与无人机.md) | 22 | PX4 / ArduPilot / 飞控板卡 / 无人机导航与仿真 |
| [电磁仿真与超表面](categories/02-电磁仿真与超表面.md) | 17 | FDTD / CST / 超表面与电磁材料设计 |
| [嵌入式与单片机](categories/03-嵌入式与单片机.md) | 50 | RTOS、MCU 生态、LVGL、MicroPython、调试与仿真工具 |
| [硬件设计与 EDA](categories/04-硬件设计与EDA.md) | 16 | KiCad / EDA / CAD / PCB / FPGA 设计流程 |
| [无线通信与感知](categories/05-无线通信与感知.md) | 11 | WiFi CSI、无线链路、IMU、GNSS 等感知与通信 |
...
| [待归类](categories/10-待归类.md) | 6 | 尚未归入上述分类的项目 |
